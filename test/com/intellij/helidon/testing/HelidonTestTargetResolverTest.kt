...
abstract class HelidonTestTargetResolverFixture : HelidonHighlightingTestCase() {
  override fun setUp() {
    super.setUp()
  ...
  protected fun configureMavenLikeSourceRoots() {
  ...
  protected fun addJavaFile(path: String, text: String): PsiFile =
    myFixture.addFileToProject(path, text)

  protected fun elementAt(file: PsiFile, text: String) =
...
class HelidonTestTargetResolverTest : HelidonTestTargetResolverFixture() {
...
class HelidonTestTargetResolverMpOnlyTest : HelidonTestTargetResolverFixture() {
  override fun getProjectDescriptor(): LightProjectDescriptor =
    HelidonProjectDescriptorBuilder()
      .withMicroProfileCdi()
      .build()

  fun testResolvesJunitMethodInMicroProfileOnlyHelidonTestSource() {
    val file = addJavaFile("src/test/java/example/GreetingTest.java", """
      package example;
    ...
    assertTrue(HelidonCoreUtils.hasHelidonMPLibrary(module))
